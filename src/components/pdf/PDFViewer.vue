  ...
  <div class="pdf-viewer">
    <header class="pdf-viewer__header box-shadow">
      <div class="pdf-preview-toggle">
        <a @click.prevent.stop="togglePreview" class="icon"><img width='22px' src='../../static/icon-preview.svg' /></a>
      </div>
...
<script>
import PreviewIcon from '../../static/icon-preview.svg';
